...
int main(int argc, char *argv[])
{
    ...
    mybloom.arrayGenerate("data/trgm.txt");
    cout<<"intNum:"<<mybloom.getIntNum()<<",hashFunNum:"<<mybloom.getHashFunNum()<<endl;
    cout<<"qwertyu2225在我的集合中吗:"<<(mybloom.isContain("qwertyu2225")?"在":"不在")<<endl;
    cout<<"qwertyu1000在我的集合中吗:"<<(mybloom.isContain("qwertyu1000")?"在":"不在")<<endl;
